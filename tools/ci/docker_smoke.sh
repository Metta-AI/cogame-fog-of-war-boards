...
# Substitute: fog-of-war-boards, coworld-fog-of-war-boards, 2.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-fog-of-war-boards:ci)
#   SMOKE_SLUG                 game slug                        (fog-of-war-boards)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/fog-of-war-boards)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/fog-of-war-boards-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-fog-of-war-boards:ci}}"
slug="${SMOKE_SLUG:-fog-of-war-boards}"
